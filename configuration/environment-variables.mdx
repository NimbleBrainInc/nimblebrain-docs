...
<ResponseField name="NTCLI_API_URL" type="string">
  Base URL for the NimbleTools API
  
  **Default**: `https://mcp.nimbletools.ai`  
...
<Tabs>
  ...
  <Tab title="Fish">
    ```fish
    set -x NTCLI_API_URL https://dev-api.nimbletools.ai
    set -x NTCLI_DEBUG 1
    ntcli auth login
    ```
  </Tab>
  <Tab title="PowerShell">
    ```powershell
    $env:NTCLI_API_URL = "https://dev-api.nimbletools.ai"
    $env:NTCLI_DEBUG = "1"
    ntcli auth login
    ```
  </Tab>
  <Tab title="Command Prompt">
    ```cmd
    set NTCLI_API_URL=https://dev-api.nimbletools.ai
    set NTCLI_DEBUG=1
    ntcli auth login
    ```
  </Tab>
...
<Tabs>
  ...
  <Tab title="Fish">
    ...
    ```fish
    # NimbleTools CLI Configuration
    set -x NTCLI_API_URL https://mcp.nimbletools.ai
