...
<CardGroup cols={2}>
  <Card
    ...
    icon="chart-line"
    href="/commands/server/scale"
  >
    ```bash
    ntcli server scale nationalparks-mcp 3 
    ```
  </Card>
  <Card title="View Server Logs" icon="file-text" href="/commands/server/logs">
    ```bash
  ...
  <Card title="Non-Expiring Tokens" icon="key" href="/commands/token/refresh">
    ```bash 
...
<Steps>
  <Step title="LangChain Integration">
    ...
    [LangChain Integration Guide](/examples/langchain-integration).
  </Step>
