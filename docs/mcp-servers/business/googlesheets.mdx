...
<CardGroup cols={2}>
  <Card title="What it does" icon="table">
    Google Sheets MCP Server connects AI tools directly to your Google Sheets, enabling natural language interactions with spreadsheets, data analysis, and automation.

    **Powered by [Composio](https://composio.dev)** with **38+ tools** for spreadsheet automation.
...
<Info>
  This connection is powered by [Composio](https://mcp.composio.dev/googlesheets) and provides access to 38+ Google Sheets tools through the Model Context Protocol (MCP).
</Info>
...
<Note>
  This is a summary of the most commonly used tools. For the complete list, visit the [Composio Google Sheets documentation](https://mcp.composio.dev/googlesheets).
</Note>
...
<CardGroup cols={2}>
  <Card title="Composio Google Sheets Docs" icon="book" href="https://mcp.composio.dev/googlesheets">
    Full documentation for all Google Sheets tools
  </Card>
