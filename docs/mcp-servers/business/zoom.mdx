...
<CardGroup cols={2}>
  <Card title="What it does" icon="video">
    Zoom MCP Server connects AI tools directly to your Zoom account, enabling natural language interactions with meetings, webinars, recordings, and user management.

    **Powered by [Composio](https://composio.dev)** with **17+ tools** for video conferencing automation.
...
<Info>
  This connection is powered by [Composio](https://mcp.composio.dev/zoom) and provides access to 17+ Zoom tools through the Model Context Protocol (MCP).
</Info>
...
<Note>
  This is the complete list of available tools. For the most up-to-date information, visit the [Composio Zoom documentation](https://mcp.composio.dev/zoom).
</Note>
...
<CardGroup cols={2}>
  <Card title="Composio Zoom Docs" icon="book" href="https://mcp.composio.dev/zoom">
    Full documentation for all Zoom tools
  </Card>
