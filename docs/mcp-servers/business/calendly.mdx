...
<CardGroup cols={2}>
  <Card title="What it does" icon="calendar-check">
    Calendly MCP Server connects AI tools directly to your Calendly account, enabling natural language interactions with scheduling, events, invitees, and booking links.

    **Powered by [Composio](https://composio.dev)** with **42+ tools** for scheduling automation.
...
<Info>
  This connection is powered by [Composio](https://mcp.composio.dev/calendly) and provides access to 42+ Calendly tools through the Model Context Protocol (MCP).
</Info>
...
<Note>
  This is a summary of the most commonly used tools. For the complete list of 42+ tools, visit the [Composio Calendly documentation](https://mcp.composio.dev/calendly).
</Note>
...
<CardGroup cols={2}>
  <Card title="Composio Calendly Docs" icon="book" href="https://mcp.composio.dev/calendly">
    Full documentation for all Calendly tools
  </Card>
