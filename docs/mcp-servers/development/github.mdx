...
<CardGroup cols={2}>
  <Card title="What it does" icon="github">
    GitHub MCP Server connects AI tools directly to GitHub's platform, enabling natural language interactions with repositories, issues, pull requests, and workflows.
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub MCP Server" icon="github" href="https://github.com/github/github-mcp-server">
    Official GitHub MCP server source code
  </Card>
