...
<CardGroup cols={2}>
  <Card title="What it does" icon="language">
    DeepL MCP Server provides professional-grade neural machine translation powered by DeepL's industry-leading AI. Translate text and documents across 30+ languages with superior quality and context awareness.
...
<CardGroup cols={3}>
  <Card title="Gmail" icon="envelope" href="/mcp-servers/productivity/gmail">
    Translate emails automatically
  </Card>

  <Card title="Slack" icon="slack" href="/mcp-servers/productivity/slack">
    Real-time message translation
  </Card>

  <Card title="Google Docs" icon="file-lines" href="/mcp-servers/productivity/google-docs">
    Translate documents in place
  </Card>

  <Card title="Google Translate" icon="language" href="/mcp-servers/language/google-translate">
    Alternative translation service
  </Card>

  <Card title="Azure Translator" icon="microsoft" href="/mcp-servers/language/azure-translator">
    Microsoft translation service
  </Card>

  <Card title="Notion" icon="file-lines" href="/mcp-servers/productivity/notion">
