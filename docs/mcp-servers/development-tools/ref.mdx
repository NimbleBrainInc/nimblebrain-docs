...
Ref MCP Server gives your AI coding assistant instant access to up-to-date technical documentation for APIs, libraries, frameworks, and services - while using minimal tokens to keep your context window clean and your AI sharp.
...
<Steps>
  ...
  <Step title="Add to Studio">
    In NimbleBrain Studio:
    1. Go to **Settings** → **MCP Servers** → **Ref**
...
<CardGroup cols={3}>
  <Card title="GitHub" icon="github" href="/mcp-servers/development/github">
    Browse repository code, issues, and pull requests
  </Card>

  <Card title="Tavily" icon="magnifying-glass" href="/mcp-servers/search-research/tavily">
    AI-powered web search and research
  </Card>

  <Card title="Echo" icon="terminal" href="/mcp-servers/development/echo">
    Test and debug MCP server connections
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Integration with Other Tools" icon="plug">
    **Using Ref with other MCP servers:**

    Ref works beautifully alongside other MCP servers for powerful workflows:
