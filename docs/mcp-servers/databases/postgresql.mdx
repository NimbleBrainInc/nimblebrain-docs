...
The PostgreSQL MCP Server requires database credentials to establish connections. You can provide connection information in two ways:
...
<CardGroup cols={2}>
  ...
  <Card title="NimbleBrain Studio" icon="toolbox" href="https://www.nimblebrain.ai">
    Explore more MCP servers and integrations
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Advanced PostgreSQL Features" icon="star">
    **Features used by this MCP server:**
