...
Configure these parameters in NimbleBrain Studio (**Settings** → **MCP Servers** → **ClickHouse**):
...
<CardGroup cols={2}>
  <Card title="GitHub Repository" icon="github" href="https://github.com/ClickHouse/mcp-clickhouse">
    View MCP server source code and report issues
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Ready for Analytics?" icon="rocket">
    **Next Steps:**
    ...
    - [Browse More MCP Servers](/mcp-servers)
  </Card>
</CardGroup>
