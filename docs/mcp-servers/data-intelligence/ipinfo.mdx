...
<CardGroup cols={2}>
  <Card title="What it does" icon="location-dot">
    IPInfo MCP Server provides comprehensive IP intelligence including geolocation, network data, security insights, and abuse detection. Make informed decisions about traffic, enhance security, and personalize experiences based on visitor location and network characteristics.
