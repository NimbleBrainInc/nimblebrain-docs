...
2. **Open an issue**: [GitHub Issues](https://github.com/nimbletools/ntcli/issues)
3. **Join our community**: [Slack](https://join.slack.com/t/nimblebrain-users/shared_invite/zt-2jpyzxgvl-7_kFJQHyJSmJzWXmYK8cMg)
