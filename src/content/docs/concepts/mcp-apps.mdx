...
1. Reads the `_meta["ai.nimblebrain/synapse"]` manifest metadata for placements and views
...
1. Adding `_meta["ai.nimblebrain/synapse"]` to its `manifest.json` with UI placements
