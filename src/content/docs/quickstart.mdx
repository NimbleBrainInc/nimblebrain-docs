...
3. **Set your environment variables and start**
   ...
   The platform container runs the agent engine on port 3000 (internal). The web container serves the UI on port 8080.
...
<CardGrid>
  <LinkCard title="Installation" description="All install methods: Docker Compose, Helm, from source" href="/installation" />
