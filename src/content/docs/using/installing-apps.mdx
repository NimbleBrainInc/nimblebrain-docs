...
The agent has access to `nb__search_registry` and `nb__manage_bundle`. This means you can ask it to find and install what it needs:

> "I need to search through meeting notes. Find a bundle for that and install it."

The agent will:
1. Call `nb__search_registry` to search mpak
