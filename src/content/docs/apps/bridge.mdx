...
<Aside type="note">
State injection is trust-gated. Only apps with an MTF trust score of 50 or higher have their state included in the LLM context. If you're using the Synapse SDK, `app.updateModelContext()` handles this automatically.
</Aside>
