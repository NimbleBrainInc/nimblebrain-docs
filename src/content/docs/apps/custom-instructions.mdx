...
- **Containment escape.** Any literal `</app-custom-instructions>` in the body is rewritten to `&lt;/app-custom-instructions>` before wrapping. Prompt-injection mitigation; you don't need to handle it.
