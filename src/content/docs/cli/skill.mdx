...
code-review       skill     50        ./skills/code-review.md
summarize         skill     50        ./skills/summarize.md
```

Skills are loaded from two sources:
1. **Core skills** (`src/skills/core/`) -- always loaded, always injected into the system prompt
2. **Config skill dirs** -- directories listed in the `skillDirs` array of your `nimblebrain.json`
...
```json
[{"name":"bootstrap","type":"context","priority":100,"source":"src/skills/core/bootstrap.md","description":"Teaches the agent about meta-tools and mpak"},{"name":"code-review","type":"skill","priority":50,"source":"./skills/code-review.md","description":"Review code for quality and correctness"}]
```
