...
<TabItem label="curl">
```bash
curl -X DELETE http://localhost:3000/v1/apps/weather \
  -H "Authorization: Bearer your-secret-key"
```
</TabItem>
<TabItem label="Response">
...
<TabItem label="curl">
```bash
curl -X POST http://localhost:3000/v1/apps/weather/start \
  -H "Authorization: Bearer your-secret-key"
```
</TabItem>
<TabItem label="Response">
...
<TabItem label="curl">
```bash
curl -X POST http://localhost:3000/v1/apps/weather/stop \
  -H "Authorization: Bearer your-secret-key"
```
</TabItem>
<TabItem label="Response">
...
<TabItem label="curl">
```bash
curl http://localhost:3000/v1/apps/tasks/resources/primary \
  -H "Authorization: Bearer your-secret-key"
```
</TabItem>
<TabItem label="Response">
