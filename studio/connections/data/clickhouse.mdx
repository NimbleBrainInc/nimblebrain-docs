...
Configure these parameters in NimbleBrain Studio (**Connections** → **ClickHouse**):
...
<Tabs>
  ...
  <Tab title="Real-Time Dashboard">
    ...
    **Example Dashboard:**
    ```
    🟢 LIVE METRICS (Updated: 10:45:30 AM)
  ...
  <Accordion title="Connection Refused" icon="triangle-exclamation">
    ...
    **Solutions:**
    ...
    1. **Verify Connection Details:**
       - Go to **Connections** → **ClickHouse** → **Edit**
...
<CardGroup cols={3}>
  <Card title="PostgreSQL" icon="database" href="/studio/connections/data/postgresql">
    Relational database for transactional data
  </Card>

  <Card title="MongoDB" icon="database" href="/studio/connections">
    NoSQL document database
  </Card>

  <Card title="Finnhub" icon="chart-line" href="/studio/connections/utilities/finnhub">
...
<CardGroup cols={2}>
  <Card title="Need Help?" icon="question-circle">
    **Support Channels:**
    - [NimbleBrain Discord](https://www.nimblebrain.ai/discord?utm_source=docs&utm_campaign=studio)
  ...
  <Card title="Ready for Analytics?" icon="rocket">
    **Next Steps:**
    ...
    - [Browse More Connections](/studio/connections)
  </Card>
</CardGroup>
