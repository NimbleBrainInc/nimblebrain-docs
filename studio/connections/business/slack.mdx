...
<CardGroup cols={2}>
  <Card title="What it does" icon="slack">
    Slack integration connects AI tools directly to your Slack workspace, enabling natural language interactions with channels, messages, users, and workflows.
