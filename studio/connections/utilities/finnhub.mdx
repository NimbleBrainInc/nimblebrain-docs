...
<iframe
  ...
  src="https://www.youtube.com/embed/Zrbm0fjIUpE"
  title="Finnhub Connection Setup"
...
<CardGroup cols={3}>
  <Card title="Alpha Vantage" icon="chart-mixed" href="/studio/connections">
    Alternative financial data with forex and crypto support
  </Card>

  <Card title="Yahoo Finance" icon="y" href="/studio/connections">
    Historical market data, options chains, and free data access
  </Card>

  <Card title="CoinGecko" icon="bitcoin-sign" href="/studio/connections">
