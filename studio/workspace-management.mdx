...
Workspaces provide isolated environments for organizing playbooks, connections, and API tokens.
...
- **Connections**: Installed integrations and their configurations
...
<Callout type="info">
  Resource quotas vary by plan. [Upgrade your plan](https://studio.nimblebrain.ai/billing?utm_source=docs&utm_campaign=studio) to increase limits.
</Callout>
