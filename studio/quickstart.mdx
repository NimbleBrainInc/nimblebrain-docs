...
<Frame>
  <img src="/images/studio/Nira-intro.png" alt="Nira Welcome Screen" />
</Frame>
...
<Frame>
  <img src="/images/studio/nirachatinterface.png" alt="Chatting with Nira" />
</Frame>
...
<Frame>
  <img src="/images/studio/playbooknira.png" alt="Automation Deployed" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Connect to Claude" icon="robot" href="/developers/integrations/overview">
...
<Tip>
**Ready for more?** Once you're comfortable with single playbooks, explore [Scheduling](/studio/scheduling) to automate recurring workflows. Set up daily reports, hourly monitors, or weekly summaries that run automatically.
</Tip>
