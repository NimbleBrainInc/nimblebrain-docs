...
When you first log into NimbleBrain Studio at [studio.nimblebrain.dev](https://studio.nimblebrain.dev), you'll see NIRA's welcome message:
...
<CardGroup cols={2}>
  ...
  <Card title="Explore Connections" icon="plug" href="/studio/connections">
    See all 50+ MCP servers NIRA can use
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="How do I know what tools/services NIRA can use?">
    Browse [Connections](/studio/connections) to see all 50+ MCP servers. NIRA automatically knows about all of them and will select the best ones for your needs.

    If NIRA doesn't have a tool for something, she'll let you know and may suggest alternatives.
  </Accordion>
